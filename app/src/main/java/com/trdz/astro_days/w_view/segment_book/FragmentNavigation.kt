...
import com.trdz.astro_days.w_view.CustomOnBackPressed
	...
	override fun onBackPressed(): Boolean {
		binding.fadeLayout.animate().alpha(1f).setDuration(1000L).setListener(object: AnimatorListenerAdapter() {
			override fun onAnimationEnd(animation: Animator?) {
				...
				executors.getNavigation().replace(requireActivity().supportFragmentManager, com.trdz.astro_days.w_view.segment_picture.FragmentNavigation(), false, R.id.container_fragment_navigation)
