...
import com.trdz.astro_days.x_view_model.MainViewModel
import androidx.core.content.ContextCompat
import com.google.android.material.bottomappbar.BottomAppBar
import com.trdz.astro_days.databinding.FragmentNavigationBinding
import com.trdz.astro_days.x_view_model.StatusMessage
import androidx.viewpager.widget.ViewPager.OnPageChangeListener
import com.google.android.material.chip.Chip
import com.trdz.astro_days.w_view.Leader
import com.trdz.astro_days.w_view.MainActivity
import com.trdz.astro_days.z_utility.KEY_FINSTANCE
...
import com.trdz.astro_days.z_utility.*
			...
			when (item.itemId) {
				R.id.app_bar_note -> {
					...
					binding.motionPicture.addTransitionListener(object: MotionLayout.TransitionListener {
						...
						override fun onTransitionChange(motionLayout: MotionLayout?, startId: Int, endId: Int, progress: Float) {}
						override fun onTransitionCompleted(motionLayout: MotionLayout?, currentId: Int) {
							executors.getNavigation().replace(requireActivity().supportFragmentManager, com.trdz.astro_days.w_view.segment_book.FragmentNavigation(), false, R.id.container_fragment_navigation)
						}
						override fun onTransitionTrigger(motionLayout: MotionLayout?, triggerId: Int, positive: Boolean, progress: Float) {
						}
					})
